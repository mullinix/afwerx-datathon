...
def loadTimeSeries(dataRoot, subject, sessLabel, expType, modality, runLabel):
    ...
    if (modality.find("feat-perfmetric") != -1):
        ...
        modalityDataFile = subject+"_"+sessLabel+"_"+expType+"_stream-"+modality+"_feat-chunk_"+runLabel+"_dc.csv";
...
def vizAggFeat_perfErr(featDF, perfDF, aggFeatColumn):
    ...
    cumErr = joinDF['GlideSlope_Error'] + joinDF['Localizer_Error'] + joinDF['Airspeed_Error'];
